...
<body>
	...
	<% if ((session.getAttribute("mdpok")) == "OK" && (session.getAttribute("captchaok")) == "OK" && (session.getAttribute("pseudo")) != null){ %>
		...
		<div style="width: 40%;margin: auto;text-align:center">
         ...
         <div class="row"> 
            ...
            <div class="input-field col s12">
         	...
         	<div style="width: 40%;margin: auto;text-align:center">
                <h2 class=" amber-text left tshadb">Captcha</h2> 
                <div class="row left">
	...
	<% } else if ((session.getAttribute("mdpok")) == "PASOK" && (session.getAttribute("captchaok")) == "OK" && (session.getAttribute("pseudo")) != null){ %>
		<section style="min-height:60vh;">
			<div style="width: 40%;margin: auto;text-align:center">
	...
	<% } else if ((session.getAttribute("mdpok")) == "OK" && (session.getAttribute("captchaok")) == "PASOK" && (session.getAttribute("pseudo")) != null){ %>
		<section style="min-height:60vh;">
			<div style="width: 40%;margin: auto;text-align:center">
         <h1 class="amber-text tshadb">Mot de passe</h1>
         <div class="row"> 
